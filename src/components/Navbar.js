            ...
            <div className='top-bar'>
                <nav className="navbar navbar-expand-lg navbar-light bg-light">
                    <div className="nav_container container">
                        <div className='brand_user_icon d-flex'>
                            <div className='d-flex'>
                                ...
                                <span className="navbar-brand ms-3">Shofy.</span>
                            </div>
                            <div className="user_icon_cart">
                                <button className="nav-link dropdown-toggle me-3" id="navbarDropdown" data-bs-toggle="dropdown" aria-expanded="false">
